 ...
 */
#ifndef S3E_EXT_ANDROIDAPPIRATER_H
#define S3E_EXT_ANDROIDAPPIRATER_H
...
/**
 * Returns S3E_TRUE if the AndroidAppirater extension is available.
 */
...
#endif /* !S3E_EXT_ANDROIDAPPIRATER_H */
